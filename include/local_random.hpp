/*
 * local_random - thread-safe straightforward random numbers
 * 
 * originally developed as part of: Ceph - scalable distributed file system
 *
...
// Basic random number facility, largely inspired by N3551:
